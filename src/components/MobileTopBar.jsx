...
export function MobileTopBar({
  ...
  const primary = profiles?.primary || { name: "You", battery: null };
  const partner = profiles?.partner || { name: "Wife", battery: null };
  ...
  return (
    <header className="mobile-topbar" aria-label="Mobile Header">
      ...
      <div
        ...
        role="radiogroup"
        aria-label="Athlete profile switcher"
      >
        <button
          role="radio"
        ...
        >
          ...
          <span className="mobile-chip-label">
            {primary.shortName || primary.name || "You"}
          </span>
          <span className="mobile-chip-battery">
            🔋{primary.battery ?? "—"}%
          </span>
        </button>
        ...
        >
          <span className="mobile-chip-emoji">👩</span>
          <span className="mobile-chip-label">
            {partner.shortName || partner.name || "Wife"}
          </span>
          <span className="mobile-chip-battery">
            🔋{partner.battery ?? "—"}%
          </span>
